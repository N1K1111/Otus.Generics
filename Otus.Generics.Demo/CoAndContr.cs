...
namespace Otus.Generics.Demo
{
    ...
    public class CoContrVarShower : IBaseDemoShower
    {
        ...
        interface IVehicleService<out T>
        {
            void Print();

        }

        class FancyService<T> : IVehicleService<T>
        {
            public void Print()
            {
        ...
        public void Show()
        {
            ...
            IVehicleService<Automobile> demoAuto = new FancyService<Automobile>();
            IVehicleService<Vehicle> demoVehicle = new FancyService<Vehicle>();
